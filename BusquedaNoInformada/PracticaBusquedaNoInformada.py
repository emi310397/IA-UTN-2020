...
if __name__ == '__main__':
    conexiones = {
        'Málaga': {'Salamanca', 'Madrid', 'Barcelona'},
        'Salamanca': {'Madrid', 'Málaga'},
        'Madrid': {'Salamanca', 'Málaga', 'Santander', 'Sevilla', 'Barcelona'},
        'Santander': {'Madrid', 'Santiago'},
        'Sevilla': {'Madrid', 'Santiago'},
        'Barcelona': {'Málaga', 'Zaragoza', 'Madrid', 'Valencia', 'Santiago'},
        'Zaragoza': {'Barcelona'},
        'Valencia': {'Granada', 'Barcelona'},
        'Granada': {'Valencia'},
        'Santiago': {'Barcelona', 'Santander', 'Sevilla'},
    }
    estado_inicial = str('Málaga')
